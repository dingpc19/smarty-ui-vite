...
<template>
  ...
  <div style="margin-bottom:20px;">
    ...
    <SmartyButton color="yellow" round plain icon="message"
      >提示按钮</SmartyButton
    >
...
<template>
  <div class="flex flex-row">
    <SmartyButton icon="edit" plain></SmartyButton>
    <SmartyButton icon="delete" plain></SmartyButton>
    <SmartyButton icon="share" plain></SmartyButton>
    <SmartyButton round plain icon="search">搜索</SmartyButton>
  </div>
</template>
```
